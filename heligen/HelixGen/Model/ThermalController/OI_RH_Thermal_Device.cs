...
{
    public class COI_RH_Thermal_Device : CThermal_Device
    {
        /// <summary>
        ...
        public COI_RH_Thermal_Device(CAssayDiagnosticInstrument instr, uint uiSlotIndex, string strThermalElementName, float fDefaultStartTemperature = 20.0F) 
        {
            _m_Lock = new object();
            _m_instr = instr;
        ...
        public override void init()
        {
            lock (_m_Lock)
            {
                ...
                _m_ThermalAdapterUnit.LoadInitialParametersRH(_m_RHConfigObj.m_uiRHChannel.ToString(),
                                                              ...
                                                              _m_RHConfigObj.m_iSensorSelection,
                                                              _m_RHConfigObj.m_iSetTemperatureType,
                                                              _m_RHConfigObj.m_iHeatCool,
                                                              _m_RHConfigObj.m_iControlMode,
                                                              _m_RHConfigObj.m_iMaxOutputLevel,
                                                              _m_RHConfigObj.m_iDirectDrive,
                                                              _m_RHConfigObj.m_iCurrentLimit
                                                             );
        ...
        private float _m_fPriorGetTemperature_forNegativeNumberFilter;
...
//          lock (_m_Lock)
        ...
        private Action<object> _m_RHRampMonitor = (object obj) =>
        {
            ...
            string strTemp;
            float fTemp;
            COI_RH_Thermal_Device pThis = (COI_RH_Thermal_Device)obj;
            ...
            pThis._m_ThermalRampMonitoring = true;
            try
            {
            ...
            catch (CPCRInstrumentSystemException InstrumentExc)
            {
                ...
                logger.Debug(InstrumentExc.ToString());
