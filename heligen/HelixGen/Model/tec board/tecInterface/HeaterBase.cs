...
namespace Accel.HeaterBoard
{
    ...
    public abstract partial class HeaterBase : BoardDevice, IHeater
    {
        ...
        {
            logger.Debug("E: {0} Activating: {1}", Name, active);
            ...
            Issue(iCmd(HActivate, "0", ActivationValue(active),
                    (ival) =>   // iVal is ignored in handler, assumes command successful
                    {
                        if (Active != active)
                        {
                            ...
                            {
                                ThermalProgress.Raise(this, new ThermalProgressArgs(_lastTemperature, monitor.TimeActive, Controlling(_last_status), Transitioning(_last_status)));
                            }
                        }
                    }), true);
        }
        ...
        public void Activate(int mode)
        {
            ...
            // channel 0, even if the heater in question is a resistive on channel 1.
            // (see: ResistiveHeater.ActivationValue())
            Issue(iCmd(HActivate, "0", mode.ToString(),
                    (ival) =>   // iVal is ignored in handler, assumes command successful
                    {
                        NActive = mode;
                        if (monitor.Activation(true))
                            ThermalProgress.Raise(this, new ThermalProgressArgs(_lastTemperature, monitor.TimeActive, Controlling(_last_status), Transitioning(_last_status)));
                    }), true);
        }
        ...
        {
            get { return _nactive; }
            internal set { _nactive = value; NotifyPropertyChange("NActive"); }
        }
        ...
        public float SetPoint
        {
            ...
            set
            {
                logger.Debug("E: {0} SetPoint <= {1}", Name, value);
        ...
        public float SampleTime
        {
            ...
            set
            {
                logger.Debug("E: {0} SampleTime <= {1} seconds", Name, value);
        ...
        public float OvershootOffset
        {
            ...
            set
            {
                logger.Debug("E: {0} OverShootOffset <= {1}", Name, value);
        ...
        public float OvershootDuration
        {
            ...
            set
            {
                logger.Debug("E: {0} OvershootDuration <= {1}", Name, value);
        ...
        public float SetpointOffset
        {
            ...
            set
            {
                logger.Debug("E: {0} SetpointOffset <= {1}", Name, value);
        ...
        public float ErrorBand
        {
            ...
            set
            {
                logger.Debug("E: {0} ErrorBand <= {1}", Name, value);
                Set(value, RkDeriv,
                    (val) =>
                    {
        ...
        public int ErrorCountLimit
        {
            ...
            set
            {
                logger.Debug("E: {0} ErrorCountLimit <= {1}", Name, value);
                Set(value, RkDeriv,
                    (val) =>
                    {
        ...
        public int Index
        {
            ...
            set
            {
                logger.Debug("E: {0} Index <= {1}", Name, value);
                _Index = value;
            }
        }
        ...
        public int PowerLimitCount
        {
            ...
            set
            {
                logger.Debug("E: {0} PowerLimitCount <= {1}", Name, value);
                Set(value, RkDeriv,
                    (val) =>
                    {
        ...
        public float sheq_A
        {
            ...
            set
            {
                logger.Debug("E: {0} sheq_A <= {1}", Name, value);
                Set(value, HsheqA,
                    (val) =>
                    {
        ...
        public float sheq_B
        {
            ...
            set
            {
                logger.Debug("E: {0} sheq_B <= {1}", Name, value);
                Set(value, HsheqC,
                    (val) =>
                    {
        ...
        public float sheq_C
        {
            ...
            set
            {
                logger.Debug("E: {0} sheq_C <= {1}", Name, value);
                Set(value, HsheqC,
                    (val) =>
                    {
       ...
       public float Propband
        {
            ...
            set
            {
                logger.Debug("E: {0} Propband <= {1}", Name, value);
                Set(value, RkDeriv,
                    (val) =>
                    {
        ...
        public float HeatRabbit_A
        {
            ...
            set
            {
                logger.Debug("E: {0} HeatRabbit_A <= {1}", Name, value);
        ...
        public float HeatRabbit_B
        {
            ...
            set
            {
                logger.Debug("E: {0} HeatRabbit_B <= {1}", Name, value);
                Set(value, TkRabbitG,
                    (val) =>
                    {
        ...
        public float HeatRabbit_C
        {
            ...
            set
            {
                logger.Debug("E: {0} HeatRabbit_C <= {1}", Name, value);
                Set(value, TkRabbitO,
                    (val) =>
                    {
        ...
        public float HeatRabbit_D
        {
            ...
            set
            {
                logger.Debug("E: {0} HeatRabbit_D <= {1}", Name, value);
                Set(value, TkRabbitD,
                    (val) =>
                    {
        ...
        public float CoolRabbit_A
        {
            ...
            set
            {
                logger.Debug("E: {0} CoolRabbit_A <= {1}", Name, value);
                Set(value, TkRabbitG2,
                    (val) =>
                    {
        ...
        public float CoolRabbit_B
        {
            ...
            set
            {
                logger.Debug("E: {0} CoolRabbit_B <= {1}", Name, value);
                Set(value, TkRabbitG,
                    (val) =>
                    {
        ...
        public float CoolRabbit_C
        {
            ...
            set
            {
                logger.Debug("E: {0} CoolRabbit_C <= {1}", Name, value);
                Set(value, TkRabbitO,
                    (val) =>
                    {
        ...
        public float CoolRabbit_D
        {
            ...
            set
            {
                logger.Debug("E: {0} CoolRabbit_D <= {1}", Name, value);
                Set(value, TkRabbitD,
                    (val) =>
                    {
        ...
        override internal bool OnStatus(Status stat)
        {
            ...
            if (stat.HasBeenReset)
            {
                ...
                ThermalProgress.Raise(this, new ThermalProgressArgs(_lastTemperature, new TimeSpan(0), Controlling(_last_status), Transitioning(_last_status)));
                no_errors = false;
            }
            ...
            if (no_errors)
            {
                ...
                logger.Debug("Heater {0} OnStatus, stat: {1} is_controlling: {2} is_transitioning: {3}", 
                    Name, ((byte)stat).ToString(), is_controlling.ToString(), is_transitioning.ToString());

                // 
                if (is_controlling)
                    logger.Debug("Heater {0} reports 'controlling'", Name);

                if (is_transitioning)
                    logger.Debug("Heater {0} reports 'transitioning", Name);

                //if (monitor.StatusUpdate(is_controlling))
                ThermalProgress.Raise(this, new ThermalProgressArgs(_lastTemperature, monitor.TimeActive, is_controlling, is_transitioning));
            }
            _last_status = stat;
            return no_errors;
        }
        ...
        {
            base.Poll();
            Issue(fCmd(HGetTemperature, (temp) => { Temperature = temp; }), true);
        }
